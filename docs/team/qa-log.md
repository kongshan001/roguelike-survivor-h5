...
| ID | 严重度 | 模块 | 描述 | 状态 | 指派 |
|----|--------|------|------|------|------|
| BUG-005 | Low | 武器-圣水 | 圣水Lv1伤害极低，单球旋转约6秒才能击杀1只僵尸 | 待修复 | frontend |
| BUG-006 | Low | 道具-磁铁 | 全图吸引后磁铁道具价值大降 | 待评估 | designer |
| BUG-007 | Low | UI-结算 | 结算画面金币用途不明确 | 待评估 | designer |
| ENH-001 | Medium | 视觉-圣经 | 圣经与圣水视觉区分度不够 | 待改进 | art |
| ENH-002 | Low | 视觉-蝙蝠 | 蝙蝠精灵10×10太小，移动端难以辨认 | 待改进 | art |
